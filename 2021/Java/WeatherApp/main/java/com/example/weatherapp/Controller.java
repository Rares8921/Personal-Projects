...
public class Controller extends Thread implements Initializable {
    ...
    private final String API_KEY = "76ba96049570cfad773ba186378c4ea9";
    ...
    private void connectNextDays() {
        try {
            ...
            ObjectMapper mapper = new ObjectMapper();
            Map<String, Object> daysMap = mapper.readValue(result.toString().getBytes(), Map.class);
            String[] arr = daysMap.get("list").toString().split(" ");
            int t1 = -1000000000, t2 = -1000000000, t3 = -1000000000, t4 = -1000000000, t5 = -1000000000; // max temp
            int tt1 = 1000000000, tt2 = 1000000000, tt3 = 1000000000, tt4 = 1000000000, tt5 = 1000000000; // min temp
            ...
            for(String s : arr) {
                if(s.startsWith("main={")) {
                    ...
                    } else if(currentDay + 5 == day) {
                        if(currentTemp > t5) {
                            t5 = currentTemp;
                            ico5 = currentIconString;
                        }
                        tt5 = Math.min(tt5, currentTemp);
                    }
            ...
            icon5.setImage(new Image("http://openweathermap.org/img/wn/" + ico5 + "@2x.png"));
        } catch(Exception e) {
            e.printStackTrace();
        }
    }
