...
import static sample.application.TimeListener.parseInt;
...
public class Timers {
	...
	public void setAndStart(Color piecesAtBottom) {
		...
		//set timeline for both players. label seconds1 is bound with secondsProperty1.
	...
	//help method to set the timeline for the players clocks.
