...
import static sample.chess.util.Converter.getAllWhiteViewPieces;
...
public final class DragAndDropHandler {
   ...
   private static final ObjectProperty<Move>   MOVE             = new SimpleObjectProperty<>();
    ...
    */
   private static final BiPredicate<Label, DragEvent> emptyOrOpponent = (l, e) -> {
      if (Objects.equals(l.getText(), "")) return true;
    ...
    * in the view.
    */
   private static final BiFunction<Label, DragEvent, Move> convertViewToModel = (l, e) -> {
    ...
    * place piece back on its start field.
    */
