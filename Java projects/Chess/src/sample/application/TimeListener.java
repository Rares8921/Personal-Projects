...
import static sample.chess.util.GameEvaluator.EvaluationResult.OUT_OF_TIME;
...
public class TimeListener implements ChangeListener<Number>{
	...
	private final sample.application.Controller controller;
	private final IntegerProperty secondsProperty;
	private final Label           seconds;
	private final Label           minutes;
	private final Label           hours;
	
	//CONSTRUCTOR
	public TimeListener(sample.application.Controller controller, IntegerProperty secondsProperty, List<Label> timeLabels) {
