...
import static sample.chess.util.MoveValidator.ValidationResult.ILLEGAL_MOVE;
import static sample.chess.util.MoveValidator.ValidationResult.KING_HAS_MOVED_CANNOT_CASTLE;
import static sample.chess.util.MoveValidator.ValidationResult.DEFENDED_SQUARE;
