...
import static sample.chess.util.Movement.down;
import static sample.chess.util.Movement.noColumns;
import static sample.chess.util.Movement.oneColumn;
import static sample.chess.util.Movement.oneRow;
import static sample.chess.util.Movement.twoRows;
import static sample.chess.util.Movement.up;
...
public class Pawn extends Piece {
    ...
    private boolean checkForTakingAPiece(Game g, Move m, Predicate<Move> directionForColor) {
        return oneColumn.test(m)
                ...
                && m.endPiecePresent() || checkForEnPassant(g, m);
    }
