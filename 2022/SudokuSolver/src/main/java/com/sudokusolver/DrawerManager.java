...
import static com.sudokusolver.SudokuSolver.PRIMARY_VIEW;
import static com.sudokusolver.SudokuSolver.SECONDARY_VIEW;
...
public class DrawerManager {
    ...
    public static void buildDrawer(AppManager app) {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("Sudoku Solver",
                "",
