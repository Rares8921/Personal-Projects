...
public final class Converter {
    ...
    static {
        try {
            // white
            FEN_MAP.put(new King(WHITE), Arrays.asList("K","♔", new FileInputStream("../resources/images/normal/whiteKing.png").toString(),
                    new FileInputStream("../resources/images/big/whiteKing2.png").toString()));
            FEN_MAP.put(new Queen(WHITE), Arrays.asList("Q","♕", new FileInputStream("resources/images/normal/whiteQueen.png").toString(),
                    new FileInputStream("resources/images/big/whiteQueen2.png").toString()));
            FEN_MAP.put(new Rook(WHITE), Arrays.asList("R","♖", new FileInputStream("resources/images/normal/whiteRook.png").toString(),
                    new FileInputStream("resources/images/big/whiteRook2.png").toString()));
            FEN_MAP.put(new Bishop(WHITE), Arrays.asList("B","♗", new FileInputStream("resources/images/normal/whiteBishop.png").toString(),
                    new FileInputStream("resources/images/big/whiteBishop2.png").toString()));
            FEN_MAP.put(new Knight(WHITE), Arrays.asList("N","♘", new FileInputStream("resources/images/normal/whiteKnight.png").toString(),
                    new FileInputStream("resources/images/big/whiteKnight2.png").toString()));
            FEN_MAP.put(new Pawn  (WHITE), Arrays.asList("P","♙", new FileInputStream("resources/images/normal/whitePawn.png").toString(),
                    new FileInputStream("resources/images/big/whitePawn2.png").toString()));
            // black
            FEN_MAP.put(new King  (BLACK), Arrays.asList("k","♚", new FileInputStream("resources/images/normal/blackKing.png").toString(),
                    new FileInputStream("resources/images/big/blackKing2.png").toString()));
            FEN_MAP.put(new Queen (BLACK), Arrays.asList("q","♛", new FileInputStream("resources/images/normal/blackQueen.png").toString(),
                    new FileInputStream("resources/images/big/blackQueen2.png").toString()));
            FEN_MAP.put(new Rook  (BLACK), Arrays.asList("r","♜", new FileInputStream("resources/images/normal/blackRook.png").toString(),
                    new FileInputStream("resources/images/big/blackRook2.png").toString()));
            FEN_MAP.put(new Bishop(BLACK), Arrays.asList("b","♝", new FileInputStream("resources/images/normal/blackBishop.png").toString(),
                    new FileInputStream("resources/images/big/blackBishop2.png").toString()));
            FEN_MAP.put(new Knight(BLACK), Arrays.asList("n","♞", new FileInputStream("resources/images/normal/blackKnight.png").toString(),
                    new FileInputStream("resources/images/big/blackKnight2.png").toString()));
            FEN_MAP.put(new Pawn  (BLACK), Arrays.asList("p","♟", new FileInputStream("resources/images/normal/blackPawn.png").toString(),
                    new FileInputStream("resources/images/big/blackPawn2.png").toString()));
