...
namespace MicroSocial_Platform
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\dumra\PycharmProjects\Assessment\bad_words_data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"text",outputColumnName:@"text")      
                                    ...
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"is_offensive",inputColumnName:@"is_offensive",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=1F,L2Regularization=1F,LabelColumnName=@"is_offensive",FeatureColumnName=@"Features"}))      
