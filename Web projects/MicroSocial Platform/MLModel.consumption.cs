...
namespace MicroSocial_Platform
{
    public partial class MLModel
    {
        ...
        {
            [LoadColumn(0)]
            [ColumnName(@"is_offensive")]
            public string is_offensive { get; set; }
        ...
        {
            [ColumnName(@"is_offensive")]
            public uint Is_offensive { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("is_offensive");
            if (labelColumn == null)
            {
                throw new Exception("is_offensive column not found. Make sure the name searched for matches the name in the schema.");
            }
